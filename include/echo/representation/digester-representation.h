#ifndef _ECHO_REPRESENTATION_DIGESTER_REPRESENTATION_H_
#define _ECHO_REPRESENTATION_DIGESTER_REPRESENTATION_H_
...
class DigesterRepresentation : public WrapperRepresentation {  
 ...
 public:
  ...
  throws NoSuchAlgorithmException {
    DigesterRepresentation(wrappedRepresentation, Digest.ALGORITHM_MD5);
  }
   ...
   */
  long exhaust() throws IOException {
    long result = -1L;
...
#endif // _ECHO_REPRESENTATION_DIGESTER_REPRESENTATION_H_
